...
(self["webpackChunkelementor_pro"] =
  self["webpackChunkelementor_pro"] || []).push([
  ["taxonomy-filter"],
  {
  ...
  \*****************************************************************/
      /***/ (__unused_webpack_module, exports) => {
        ...
        function setHorizontalTitleScrollValues(
          element,
        ...
        function isHorizontalScroll(element, horizontalScrollStatus) {
          return (
            element.clientWidth < getChildrenWidth(element.children) &&
            "enable" === horizontalScrollStatus
          );
        }
        ...
        function initialScrollPosition(element, direction, justifyCSSVariable) {
          ...
          switch (direction) {
            case "end":
              ...
              element.scrollLeft = isRTL
                ? -1 * getChildrenWidth(element.children)
                : getChildrenWidth(element.children);
              break;
            default:
              element.style.setProperty(justifyCSSVariable, "start");
  ...
  \*****************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _flexHorizontalScroll = __webpack_require__(
          /*! elementor-pro/frontend/utils/flex-horizontal-scroll */ "../assets/dev/js/frontend/utils/flex-horizontal-scroll.js"
        );
        var _queryConstants = __webpack_require__(
          /*! ../../query-constants */ "../modules/loop-filter/assets/js/query-constants.js"
        );
        class TaxonomyFilter extends elementorModules.frontend.handlers.Base {
          ...
          getHeadingEvents() {
            ...
            return {
              mousedown: _flexHorizontalScroll.changeScrollStatus.bind(
                this,
                container
              ),
              mouseup: _flexHorizontalScroll.changeScrollStatus.bind(
                this,
                container
              ),
              mouseleave: _flexHorizontalScroll.changeScrollStatus.bind(
                this,
                container
              ),
              mousemove:
                _flexHorizontalScroll.setHorizontalTitleScrollValues.bind(
                  this,
                  container,
          ...
          bindEvents() {
            ...
            this.resizeListenerNestedTabs =
              _flexHorizontalScroll.setHorizontalScrollAlignment.bind(
                this,
                settingsObject
              );
          ...
          onElementChange(propertyName) {
            if (this.checkSliderPropsToWatch(propertyName)) {
              ...
              (0, _flexHorizontalScroll.setHorizontalScrollAlignment)(
                settingsObject
              );
            }
          }
          ...
          checkSliderPropsToWatch(propertyName) {
            return (
              0 === propertyName.indexOf("horizontal_scroll") ||
              0 === propertyName.indexOf("item_alignment_horizontal")
            );
          }
          ...
          getActiveFilterButtonElements() {
            return this.getFilterButtonElements().filter(
              '[aria-pressed="true"]'
            );
          }
          ...
          activateFilterButton(selectedTermSlug) {
            const $filterButtons = this.getFilterButtonElements(),
              multipleSelectionActive =
                "yes" === this.getElementSettings("multiple_selection");
          ...
          deactivateFilterButton(clickedFilter) {
            ...
            const $activeButton = $filterButtons.filter(
              ...
              isActivateDefaultFilterButtonNeeded =
                !multipleSelectionActive ||
                (!currentlyActiveButtons.includes(defaultFilter) &&
                  1 === currentlyActiveButtons.length);
          ...
          activateDefaultFilterButton() {
            const $filterButtons = this.getFilterButtonElements(),
              $defaultButton = $filterButtons.filter(
                '[data-filter="' +
          ...
          deactivateDefaultFilterButton() {
            const $filterButtons = this.getFilterButtonElements();
            const $defaultButton = $filterButtons.filter(
          ...
          getCurrentlyActiveFilter() {
            ...
            for (let i = 0; i < $activeFilterButtons.length; i++) {
              currentlyActiveFilterButtons.push(
                $activeFilterButtons[i].dataset.filter
              );
            }
          ...
          getFilterOperator() {
            ...
            if (
              !multipleSelection ||
              !["AND", "OR"].includes(elementSettings.logical_combination)
            ) {
              return "DISABLED";
            }
          ...
          filterItems(selectedTermSlug) {
            ...
            if (defaultFilterValue === selectedTermSlug) {
              elementorProFrontend.modules.taxonomyFilter.removeFilterFromLoopWidget(
                elementSettings.selected_element,
                this.getID(),
                selectedTermSlug,
                defaultFilterValue
              );
          ...
          onFilterButtonClick(event) {
            ...
            const currentlyActiveFilterButtons =
                this.getCurrentlyActiveFilter(),
              clickedFilter = event.currentTarget?.dataset?.filter;
            if (
              this.userClickedOnAllWhileItWasActive(
                clickedFilter,
                currentlyActiveFilterButtons
              )
            ) {
          ...
          removePaginationHiddenClassOnLoopWidgetContainer() {
            const elementSettings = this.getElementSettings(),
              loopWidget = document.querySelector(
                ".elementor-element-" + elementSettings.selected_element
              );
            if (loopWidget) {
           ...
           */
          userClickedOnAllWhileItWasActive(
            clickedFilter,
            currentlyActiveFilter
          ) {
            return (
              currentlyActiveFilter.includes(clickedFilter) &&
              clickedFilter === this.getSettings("filterValues.default")
            );
          }
          onDestroy() {
          ...
          populateLoopWidgetsStoreOnInitialPageLoad() {
            ...
            let selectedTermSlugs = urlParams.get(
              "e-filter-" +
                elementSettings.selected_element +
                "-" +
                elementSettings.taxonomy
            );
          ...
          getTermsFromParams(params) {
            let separator =
              _queryConstants.queryConstants.AND.separator.fromBrowser; // The web browser automatically replaces the plus sign with a space character before sending the data to the server.

            if (
              params.includes(
                _queryConstants.queryConstants.OR.separator.fromBrowser
              )
            ) {
              separator =
                _queryConstants.queryConstants.OR.separator.fromBrowser;
