...
<div id="asl-storelocator" class="asl-cont storelocator-main asl-template-list-2 asl-bg-<?php echo $all_configs['color_scheme'] ?> asl-text-<?php echo $all_configs['font_color_scheme'] . $class; ?>">
    <div class="sl-container ">
        <div id="asl-panel" class="sl-row">
            ...
            <div class="pol-12">
                <div class="sl-row">
                    <div class="pol-md-4 pol-lg-3 pol-xl-2 pb-2">
                                        ...
                                        if (isset($filter_ddl))
                                            ...
                                            <div class="pol-md-12 asl-ddl-filters d-none">
                                                <div class="asl-filter-cntrl">
                                                    ...
                                                    <div class="sl-dropdown-cont" id="<?php echo $key; ?>_filter"></div>
                                                </div>
                                            </div>
                                        <?php endforeach; ?>
                                        <div class="pol-md-12">
                    ...
                    <div class="pol-md-8 pol-lg-9 pol-xl-10">
